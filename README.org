...
This repository contains a modular collection of dotfiles and
configuration managed by [[https://github.com/0k/0k-cfg][0k-cfg]]. Each directory is a self-contained
*charm* (module) that manages configuration for a specific tool or
service.
...
cfg setup emacs         # Deploy emacs configuration
#+end_src
...
| =emacs=           | Extensive org-mode based Emacs configuration     |
...
| =lofree-keyboard= | Lofree keyboard fixes (fn-keys, repeat rate)     |
